...
<#assign footerTitleDefault = "Des offres d'emploi au Maroc">
<#assign footerTextDefault = "Retrouvez les annonces par ville et par domaine, partout au Royaume


.">
<#assign footerBottomDefault = "">

<#-- Surcharge par les zones dynamiques (même logique que result.ftl) -->
<#if zones??>
